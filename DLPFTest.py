...
from utils import batch_psnr, batch_ssim, batch_fsim, batch_vif, batch_fsimgray, normalize, remove_dataparallel_wrapper
import lpips
...
def test_ffdnet(**args):
    ...
    if in_ch == 3:
        ...
        model_fn = './logs/DLPFMixedNoise/best_model.pth'
