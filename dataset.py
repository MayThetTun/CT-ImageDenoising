...
def prepare_data(data_path,
                 ...
                 aug_times=1,
                 gray_mode=False):
    r"""Builds the training and validations datasets by scanning the corresponding directories for images and
    extracting patches from them.
...
"""
    ...
    if gray_mode:
        traindbf = 'gray_train.h5'
        valdbf = 'gray_val.h5'
    else:
        traindbf = 'color_train.h5'
        valdbf = 'color_val.h5'
...
class Dataset(udata.Dataset):
    ...
    def __init__(self, train=True, gray_mode=False, shuffle=False):
        ...
        if self.gray_mode:
            self.traindbf = 'gray_train.h5'
            self.valdbf = 'gray_val.h5'
        else:
            self.traindbf = 'color_train.h5'
            self.valdbf = 'color_val.h5'
